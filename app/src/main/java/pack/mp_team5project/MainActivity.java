...
public class MainActivity extends AppCompatActivity {
    ...
    Button myPage_btn, registerPage_btn, searchPage_btn, alarmPage_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerPage_btn = (Button) findViewById(R.id.registerPage_btn);
        ...
        searchPage_btn = (Button) findViewById(R.id.searchPage_btn);
        searchPage_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentToSearchPage = new Intent(MainActivity.this, SearchActivity.class);
                startActivity(intentToSearchPage);
            }
        });

        alarmPage_btn = (Button) findViewById(R.id.alarmPage_btn);
